"""
config_family.py — Centralised settings for Pakistan Family Law RAG Agent
...
class FamilyConfig:
    ...
    VECTOR_STORE_PATH = str(BASE_DIR / "vector_store_family" / "faiss_index")

    # ── Google Gemini LLM ────────────────────────────────────────────
    GEMINI_MODEL = "gemini-3.6-flash"
    TEMPERATURE  = 0.1       # Low = more factual (critical for legal accuracy)
    MAX_TOKENS   = 7000      # Max response length
