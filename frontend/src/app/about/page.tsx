      ...
      <section className="py-20 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <div className="hidden lg:block absolute left-[27px] top-4 bottom-4 w-px bg-gradient-to-b from-emerald-200 via-[#0c9344] to-emerald-100" />
            <div className="space-y-6">
              {PROBLEM.points.map((point, i) => (
                <FadeIn key={i} delay={i * 0.06}>
                  <div className="flex gap-5 lg:gap-8 group">
                    <div className="relative shrink-0 w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0c9344] to-[#0c9344] flex items-center justify-center shadow-lg shadow-[#0c9344]/20 group-hover:scale-105 transition-transform">
      ...
      <section className="py-20 lg:py-24 bg-[#0c9344]/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-[#0c9344] font-medium text-lg">{AIMS.objective}</p>
          </FadeIn>

          <div className="grid lg:grid-cols-2 gap-8">
            <FadeIn>
              <div className="h-full rounded-3xl bg-white border border-[#0c9344]/15 p-8 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-11 h-11 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                    <Target className="w-5 h-5 text-[#0c9344]" />
                  </div>
                ...
                <ul className="space-y-4">
                  {AIMS.aims.map((aim) => (
                    <li key={aim} className="flex items-start gap-3">
                      <span className="mt-1 w-5 h-5 rounded-full bg-[#0c9344]/15 flex items-center justify-center shrink-0">
            ...
            <FadeIn delay={0.08}>
              <div className="h-full rounded-3xl bg-gradient-to-br from-[#0c9344] to-[#0c9344] p-8 text-white shadow-xl shadow-[#0c9344]/20">
                <div className="flex items-center gap-3 mb-6">
                ...
                <ul className="space-y-4">
                  {AIMS.vision.map((item) => (
                    <li key={item} className="flex items-start gap-3">
                      <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#0c9344] shrink-0" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {DATA_SOURCES.map((source, i) => (
              <FadeIn key={source.title} delay={i * 0.05}>
                <div
                  className={`h-full p-6 rounded-2xl border transition-all hover:shadow-lg hover:shadow-[#0c9344]/5 ${
                    i === 0 || i === 3
                      ? 'bg-[#0c9344]/10/60 border-[#0c9344]/25 lg:row-span-1'
                      : 'bg-white border-slate-200 hover:border-[#0c9344]/25'
                  }`}
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {TEAM.map((member, i) => (
              <FadeIn key={member.name} delay={i * 0.06}>
                <article className="group h-full rounded-2xl bg-white border border-slate-200 p-6 hover:border-[#0c9344]/25 hover:shadow-xl hover:shadow-[#0c9344]/8 transition-all duration-300">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#0c9344] to-[#0c9344] flex items-center justify-center text-white font-bold text-lg mb-4 shadow-md shadow-[#0c9344]/25 group-hover:scale-105 transition-transform">
                    {member.name.split(' ').slice(-1)[0]?.[0] ?? member.name[0]}
                  </div>
                  <h3 className="font-extrabold text-slate-900 mb-0.5">{member.name}</h3>
                  <p className="text-[#0c9344] text-sm font-semibold mb-3">{member.role}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            <FadeIn className="lg:col-span-3">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-11 h-11 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                  <TrendingUp className="w-5 h-5 text-[#0c9344]" />
                </div>
              ...
              <ul className="grid sm:grid-cols-2 gap-4">
                {IMPACT.system.map((item) => (
                  <li key={item} className="flex items-start gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100">
                    <Shield className="w-4 h-4 text-[#0c9344] mt-0.5 shrink-0" />
            ...
            <FadeIn delay={0.1} className="lg:col-span-2">
              <div className="h-full rounded-3xl border border-[#0c9344]/25 bg-gradient-to-br from-emerald-50 to-white p-8">
                <h3 className="font-heading text-xl font-semibold text-slate-900 mb-4">Get in touch</h3>
                <div className="space-y-4">
                  <a
                    href={`mailto:${SITE.email}`}
                    className="flex items-center gap-3 text-slate-600 hover:text-[#0c9344] transition-colors group"
                  >
                ...
                <Link
                  href="/contact"
                  className="mt-6 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0c9344] text-white text-sm font-bold hover:bg-[#0c9344] transition-colors"
                >
                  Contact the team
                </Link>
              </div>
