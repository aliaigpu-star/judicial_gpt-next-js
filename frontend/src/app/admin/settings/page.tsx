    ...
    return (
        ...
        >
            <div className="flex items-start gap-4 mb-6">
                <div className="p-3 bg-emerald-700/10 rounded-xl">
    ...
    return (
        <div className="flex items-center justify-between py-4 border-b border-gray-800 last:border-0">
            ...
            <button
                ...
                disabled={disabled}
                className={`relative w-12 h-6 rounded-full transition-colors ${enabled ? 'bg-emerald-700' : 'bg-gray-700'
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                >
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex items-center gap-2 px-4 py-2.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl transition-all disabled:opacity-50"
                    >
                        {saving ? (
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl">
                            ...
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm ${systemStatus?.checks.database
                                ...
                                <span className={`w-2 h-2 rounded-full ${systemStatus?.checks.database ? 'bg-emerald-400' : 'bg-red-400'
                                    }`} />
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl">
                            ...
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm ${systemStatus?.checks.api
                                ...
                                <span className={`w-2 h-2 rounded-full ${systemStatus?.checks.api ? 'bg-emerald-400' : 'bg-red-400'
                                    }`} />
                        ...
                        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl">
                            ...
                            <div className="flex items-center gap-2 px-3 py-1 rounded-full text-sm bg-emerald-700/10 text-emerald-700">
                                ...
                                <div className="pt-2 space-y-4 border-t border-gray-800">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-emerald-700/50 focus:border-emerald-700/50 outline-none"
                                        />
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-emerald-700/50 focus:border-emerald-700/50 outline-none"
                                            />
                                        </div>
