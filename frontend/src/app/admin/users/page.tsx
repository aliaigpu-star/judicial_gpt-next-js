        ...
        <div className="p-4 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 md:mb-8">
                ...
                >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl transition-all"
                    >
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 w-full sm:min-w-[280px]">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-emerald-700/50 focus:border-emerald-700/50 transition-all"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-white outline-none focus:ring-2 focus:ring-emerald-700/50 focus:border-emerald-700/50 cursor-pointer"
                        >
                    ...
                    <select
                        ...
                        className="px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-white outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 cursor-pointer"
                    >
            ...
            {selectedUsers.length > 0 && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="bg-emerald-700/10 border border-emerald-700/30 rounded-xl p-4 mb-6"
                >
                    ...
                    {/* Bulk Status Update */}
                    {bulkAction === 'status' && (
                        <div className="mt-4 pt-4 border-t border-emerald-700/20 flex items-center gap-4 flex-wrap">
                            <span className="text-emerald-400 text-sm">Update status to:</span>
                            <select
                                value={bulkStatus}
                                onChange={(e) => setBulkStatus(e.target.value)}
                                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white outline-none focus:ring-2 focus:ring-emerald-700/50"
                            >
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                                <option value="suspended">Suspended</option>
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg transition-all text-sm"
                            >
                                Apply
                            </button>
                            <button
