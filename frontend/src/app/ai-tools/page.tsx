    ...
    <SiteShell>
      ...
      >
        <div className="flex flex-wrap gap-3">
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#00a859] text-white font-bold shadow-md shadow-[#00a859]/25 hover:bg-[#00a859] transition-colors"
          >
            Start Free <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            href="/features"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 font-semibold hover:border-[#00a859]/25 hover:bg-[#00a859]/10/50 transition-colors"
          >
            View All Features
          </Link>
        </div>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="relative overflow-hidden rounded-3xl border border-[#00a859]/15 bg-gradient-to-br from-[#00a859]/5 via-white to-emerald-50/40 shadow-xl shadow-[#00a859]/5">
              <div className="absolute top-0 right-0 w-72 h-72 bg-[#00a859]/10 rounded-full blur-3xl pointer-events-none" />
              <div className="relative grid lg:grid-cols-5 gap-0">
                <div className="lg:col-span-3 p-8 md:p-10 lg:p-12">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-[0.12em] mb-5 bg-[#00a859] text-white">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {chatbot.features.map((feat) => (
                      <div
                        key={feat}
                        className="flex items-center gap-2.5 text-sm text-slate-600 bg-white/80 rounded-xl px-4 py-3 border border-[#00a859]/15/80"
                      >
                        <span className="w-5 h-5 rounded-full bg-[#00a859]/15 flex items-center justify-center shrink-0">
                ...
                <div className="lg:col-span-2 flex items-center justify-center p-8 md:p-10 bg-gradient-to-br from-[#00a859] to-[#00a859]">
      ...
      <section className="py-16 lg:py-20 bg-[#F7FAF8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {/* Case Prism */}
            <FadeIn delay={0.05}>
              <div className="h-full rounded-3xl border border-slate-200 bg-white overflow-hidden hover:border-[#00a859]/25 hover:shadow-lg hover:shadow-[#00a859]/5 transition-all duration-300">
                <div className="h-2 bg-gradient-to-r from-[#00a859] to-[#00a859]" />
                <div className="p-8 md:p-10">
                  <div className="flex items-start justify-between gap-4 mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-[#00a859]/10 border border-[#00a859]/15 flex items-center justify-center">
                      <Layers className="w-7 h-7 text-[#00a859]" />
                    </div>
                  ...
                  <ul className="space-y-3 mb-8">
                    {casePrism.features.map((feat) => (
                      <li key={feat} className="flex items-center gap-3 text-sm text-slate-600">
                        <FileSearch className="w-4 h-4 text-[#00a859] shrink-0" />
                        {feat}
                      </li>
                    ))}
                  </ul>
                  <div className="pt-6 border-t border-slate-100 flex items-center gap-4 text-xs text-slate-400">
                    <span className="inline-flex items-center gap-1.5">
                      <Zap className="w-3.5 h-3.5 text-[#00a859]" /> Relevance-ranked results
                    </span>
                    <span className="inline-flex items-center gap-1.5">
                      <Layers className="w-3.5 h-3.5 text-[#00a859]" /> Millions of cases
                    </span>
                  </div>
                </div>
              </div>
            ...
            <FadeIn delay={0.1}>
              <div className="h-full rounded-3xl border border-slate-200 bg-white overflow-hidden hover:border-[#00a859]/25 hover:shadow-lg hover:shadow-[#00a859]/5 transition-all duration-300">
                ...
                <div className="p-8 md:p-10">
                  <div className="flex items-start justify-between gap-4 mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-[#00a859]/10 border border-[#00a859]/15 flex items-center justify-center">
                      <UserCheck className="w-7 h-7 text-[#00a859]" />
                    </div>
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold uppercase tracking-wider bg-[#00a859]/10 text-[#00a859] border border-[#00a859]/25">
                  ...
                  <ul className="space-y-3 mb-8">
                    {consultant.features.map((feat) => (
                      <li key={feat} className="flex items-center gap-3 text-sm text-slate-600">
                        <Check className="w-4 h-4 text-[#00a859] shrink-0" strokeWidth={2.5} />
                        {feat}
                      </li>
                    ))}
                  </ul>
                  <div className="rounded-2xl bg-[#00a859]/5 border border-[#00a859]/15 p-4">
                    <p className="text-sm text-slate-600 leading-relaxed">
                      <span className="font-semibold text-[#00a859]">Strategic guidance</span> without the wait — explore outcomes, risks, and next steps before your next hearing.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="space-y-4">
                {IMPACT.staff.map((item) => (
                  <li key={item} className="flex items-start gap-3 text-slate-600">
                    <span className="mt-1 w-6 h-6 rounded-lg bg-[#00a859]/15 flex items-center justify-center shrink-0">
                      <Mic className="w-3.5 h-3.5 text-[#00a859]" />
                    </span>
            ...
            <FadeIn delay={0.1}>
              <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-slate-900 to-emerald-950 p-8 md:p-10 text-white">
                ...
                <div className="relative z-10">
                  <p className="text-[#00a859] text-sm font-semibold uppercase tracking-wider mb-3">
                    Voice & documents
                  </p>
          ...
          <FadeIn>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/features"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white border border-slate-200 text-slate-700 font-semibold text-sm hover:border-[#00a859]/25 hover:text-[#00a859] transition-colors"
                >
                ...
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00a859] text-white font-bold text-sm shadow-md shadow-[#00a859]/20 hover:bg-[#00a859] transition-colors"
                >
