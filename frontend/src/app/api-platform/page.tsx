    ...
    <SiteShell>
      ...
      <section className="py-20 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
            {[
              ...
              <FadeIn key={item.label} delay={i * 0.05}>
                <div className="h-full p-6 rounded-2xl border border-slate-200 bg-[#F7FAF8] hover:border-[#00a859]/25 transition-colors">
                  <div className="w-11 h-11 rounded-xl bg-[#00a859]/15 flex items-center justify-center mb-4">
                    <item.icon className="w-5 h-5 text-[#00a859]" />
                  </div>
                  <p className="text-[11px] font-bold uppercase tracking-wider text-[#00a859] mb-2">
                    {item.label}
                  </p>
          ...
          <FadeIn delay={0.15}>
            <div className="rounded-2xl border border-[#00a859]/15 bg-[#00a859]/5 p-6 md:p-8">
              <p className="text-[11px] font-bold uppercase tracking-wider text-[#00a859] mb-4">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {TECH_STACK.models.map((model) => (
                  <div
                    key={model}
                    className="flex items-start gap-2.5 text-sm text-slate-600 bg-white rounded-xl px-4 py-3 border border-[#00a859]/15/80"
                  >
                    <Zap className="w-4 h-4 text-[#00a859] shrink-0 mt-0.5" />
                    {model}
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            <FadeIn>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-[#00a859]/10 border border-[#00a859]/25 text-sm text-[#00a859]">
            ...
            <FadeIn delay={0.1}>
              <div className="rounded-2xl overflow-hidden border border-slate-800 bg-slate-950 shadow-2xl">
                <div className="flex items-center gap-2 px-4 py-3 bg-slate-900 border-b border-slate-800">
                  ...
                  <span className="w-3 h-3 rounded-full bg-[#00a859]/80" />
                  <span className="ml-2 text-xs text-slate-400 font-mono">legal-research.sh</span>
                </div>
                <div className="p-5 overflow-x-auto">
                  <pre className="text-[13px] leading-relaxed font-mono">
                    <code>
                      <span className="text-[#00a859]">{SAMPLE_REQUEST}</span>
                      {'\n\n'}
            ...
            <FadeIn delay={0.08} className="lg:col-span-3">
              <ul className="grid sm:grid-cols-2 gap-4">
                {SECURITY_HIGHLIGHTS.map((item, i) => (
                  <li
                    key={item}
                    className="flex items-start gap-3 p-4 rounded-xl border border-slate-200 bg-slate-50/50 hover:border-[#00a859]/25 hover:bg-[#00a859]/10/30 transition-colors"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {ENTERPRISE_FEATURES.map((feat, i) => (
              <FadeIn key={feat.title} delay={i * 0.05}>
                <div className="h-full p-6 rounded-2xl bg-white border border-[#00a859]/15/80 hover:shadow-lg hover:shadow-[#00a859]/5 hover:border-[#00a859]/25 transition-all duration-300">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-[#00a859] to-[#00a859] flex items-center justify-center mb-4 shadow-md shadow-[#00a859]/20">
          ...
          <FadeIn delay={0.2} className="mt-12 text-center">
            <div className="inline-flex flex-col sm:flex-row items-center gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[#00a859] text-white font-bold shadow-md shadow-[#00a859]/25 hover:bg-[#00a859] transition-colors"
              >
                Request Enterprise Demo <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-semibold hover:border-[#00a859]/25 transition-colors"
              >
                Create Account
              </Link>
            </div>
