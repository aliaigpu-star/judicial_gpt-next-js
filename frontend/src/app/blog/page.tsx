          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {BLOG_POSTS.map((post, i) => (
              <FadeIn key={post.slug} delay={i * 0.05}>
                <a
                  href={`#${post.slug}`}
                  className="group block h-full rounded-2xl border border-slate-200 bg-white p-6 hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-500/8 transition-all duration-300"
                >
                  ...
                  <h3 className="font-extrabold text-slate-900 mb-2 group-hover:text-emerald-700 transition-colors leading-snug">
                    {post.title}
                  </h3>
