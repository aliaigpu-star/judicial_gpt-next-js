...
export default function CommunityPage() {
  ...
  return (
    <SiteShell>
      ...
      >
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-white border border-[#0c9344]/25 shadow-sm">
          <Heart className="w-4 h-4 text-[#0c9344]" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 text-[#0c9344] font-bold hover:underline"
              >
            ...
            {AUDIENCES.map((aud, i) => {
              ...
              return (
                <FadeIn key={aud.title} delay={i * 0.06}>
                  <Link
                    href={aud.href}
                    className="group block h-full p-6 rounded-2xl border border-slate-200 bg-white hover:border-[#0c9344] hover:shadow-xl hover:shadow-[#0c9344]/10 transition-all"
                  >
                    <div className="w-12 h-12 rounded-xl bg-[#0c9344]/15 flex items-center justify-center mb-4 group-hover:bg-[#0c9344] transition-colors">
                      <Icon className="w-5 h-5 text-[#0c9344] group-hover:text-white transition-colors" />
                    </div>
                ...
                <FadeIn key={ch.title} delay={i * 0.05}>
                  <div className="h-full p-6 rounded-2xl border border-slate-200 bg-[#F7FAF8]">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 rounded-md bg-[#0c9344]/15 text-[#0c9344]">
                        {ch.tag}
                      </span>
                    </div>
      ...
      {/* Impact + Guidelines */}
      <section className="py-16 lg:py-20 bg-[#0c9344]/5">
          ...
          <FadeIn>
            ...
            <div className="space-y-6">
              {(
                ...
                <div key={title} className="p-5 rounded-xl bg-white border border-[#0c9344]/15">
          ...
          <FadeIn delay={0.08}>
            ...
            <ul className="space-y-3 mb-8">
              {GUIDELINES.map((rule) => (
                ...
                >
                  <span className="w-6 h-6 rounded-full bg-[#0c9344]/15 text-[#0c9344] text-xs font-bold flex items-center justify-center shrink-0">
