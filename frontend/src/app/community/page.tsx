...
export default function CommunityPage() {
  ...
  return (
    <SiteShell>
      ...
      >
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-white border border-emerald-200 shadow-sm">
            ...
            {AUDIENCES.map((aud, i) => {
              ...
              return (
                <FadeIn key={aud.title} delay={i * 0.06}>
                  <Link
                    href={aud.href}
                    className="group block h-full p-6 rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-500/10 transition-all"
                  >
      ...
      {/* Impact + Guidelines */}
      <section className="py-16 lg:py-20 bg-[#F2FBF6]">
          ...
          <FadeIn>
            ...
            <div className="space-y-6">
              {(
                ...
                <div key={title} className="p-5 rounded-xl bg-white border border-emerald-100">
