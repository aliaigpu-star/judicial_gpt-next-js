...
function ContactForm() {
  ...
  if (submitted) {
    return (
      <FadeIn>
        <div className="rounded-2xl border border-[#00a859]/25 bg-[#00a859]/10 p-10 text-center">
          <CheckCircle2 className="w-14 h-14 text-[#00a859] mx-auto mb-4" />
          ...
          <p className="text-slate-600 mb-6 max-w-sm mx-auto">
            ...
            <span className="font-semibold text-[#00a859]">{form.email}</span> within two business days.
          </p>
          <button
            type="button"
            onClick={() => {
            ...
            className="text-sm font-semibold text-[#00a859] hover:text-[#00a859] hover:underline"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00a859]/30 focus:border-[#00a859] transition-all"
              />
            </div>
          </div>
          <div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#00a859]/30 focus:border-[#00a859] transition-all appearance-none cursor-pointer"
          >
            {TOPICS.map((t) => (
        ...
        <div>
          ...
          <div className="relative">
            ...
            <textarea
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#00a859]/30 focus:border-[#00a859] transition-all resize-y min-h-[140px]"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-[#00a859] text-white font-bold shadow-md shadow-[#00a859]/25 hover:bg-[#00a859] transition-colors"
        >
          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
            ...
            <FadeIn className="lg:col-span-2">
              <div className="sticky top-28 space-y-8">
                <div>
                  <p className="text-[#00a859] font-bold text-sm uppercase tracking-wider mb-2">
                    {SITE.tagline}
                  </p>
                ...
                <div className="space-y-5">
                  <a
                    ...
                    className="flex items-start gap-4 p-4 rounded-xl border border-slate-200 hover:border-[#00a859]/25 hover:bg-[#00a859]/10/40 transition-all group"
                  >
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-slate-900 group-hover:text-[#00a859] transition-colors">
                        {SITE.email}
                      </p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-slate-900 group-hover:text-[#00a859] transition-colors inline-flex items-center gap-1">
                        {SITE.url}
                ...
                <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-[#00a859]/0 group-hover:bg-[#00a859]/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                      <span className="px-3 py-1.5 rounded-full bg-white/90 text-xs font-semibold text-[#00a859] shadow">
                        Open in Google Maps ↗
                      </span>
                    </div>
                  </a>
                  <div className="p-5 bg-white">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group inline-flex items-center gap-1.5 font-extrabold text-slate-900 hover:text-[#00a859] transition-colors mb-1"
                    >
                      <MapPin className="w-4 h-4 shrink-0 text-[#00a859]" />
                      Lahore · KICS
                    </a>
