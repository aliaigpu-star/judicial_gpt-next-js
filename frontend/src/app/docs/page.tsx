                      ...
                      <a
                        ...
                        className={`flex items-center gap-2.5 px-3 py-2.5 text-sm rounded-lg transition-colors ${
                          activeSection === id
                            ...
                            : 'text-slate-600 hover:bg-[#00a859]/10 hover:text-[#00a859]'
                        }`}
                      >
            ...
            <div className="space-y-16 lg:space-y-20 min-w-0">
              ...
              <FadeIn>
                <section id="getting-started" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#00a859]/15 flex items-center justify-center">
                      <Rocket className="w-5 h-5 text-[#00a859]" />
                    </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={card.step}
                        className="p-5 rounded-2xl border border-slate-200 bg-[#F7FAF8] hover:border-[#00a859]/25 transition-colors"
                      >
                        <span className="text-xs font-bold text-[#00a859]">{card.step}</span>
                ...
                <section id="features" className="scroll-mt-28">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {CORE_FEATURES.map((feat) => (
                      <div
                        key={feat.title}
                        className="p-5 rounded-2xl border border-slate-200 bg-white hover:shadow-md hover:border-[#00a859]/25 transition-all"
                      >
                  ...
                  <Link
                    href="/features"
                    className="inline-flex items-center gap-1 mt-6 text-sm font-semibold text-[#00a859] hover:underline"
                  >
              ...
              <FadeIn>
                <section id="architecture" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#00a859]/15 flex items-center justify-center">
                      <Server className="w-5 h-5 text-[#00a859]" />
                    </div>
                    <h2 className="font-heading text-2xl md:text-3xl font-semibold text-slate-900">
                      Architecture
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
                      {[
                        ...
                        <div key={label} className="p-6 bg-white">
                          <Icon className="w-5 h-5 text-[#00a859] mb-3" />
                ...
                <section id="security" className="scroll-mt-28">
                  ...
                  <ul className="grid sm:grid-cols-2 gap-3">
                    {SECURITY.map((point) => (
                      <li
                        key={point}
                        className="flex gap-2.5 p-4 rounded-xl border border-[#00a859]/15 bg-[#00a859]/10/40 text-sm text-slate-700"
                      >
              ...
              <FadeIn>
                <section id="reliability" className="scroll-mt-28">
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-900 to-emerald-950 text-white mb-6">
                    <p className="text-[#00a859] text-sm font-bold uppercase tracking-wider mb-2">
                      Design principle
                    </p>
                  ...
                  <ul className="space-y-3">
                    {RELIABILITY.map((item) => (
                      <li key={item} className="flex gap-3 text-slate-600 text-sm leading-relaxed">
                        <CheckCircle className="w-4 h-4 text-[#00a859] shrink-0 mt-0.5" />
                        {item}
                      </li>
                    ))}
                  </ul>
              ...
              <FadeIn>
                <section id="impact" className="scroll-mt-28">
                    ...
                    {(
                      ...
                      <div
                        ...
                        className={`p-6 rounded-2xl border ${
                          accent === 'emerald'
                            ? 'border-[#00a859]/25 bg-[#00a859]/10/50'
                            : accent === 'teal'
                              ? 'border-[#00a859]/25 bg-[#00a859]/10/40'
                        ...
                        <ul className="space-y-3">
                          {items.map((item) => (
                            <li key={item} className="flex gap-2 text-sm text-slate-600 leading-relaxed">
                              <span className="w-1 h-1 rounded-full bg-[#00a859] mt-2 shrink-0" />
                              {item}
                            </li>
                          ))}
                        </ul>
                  ...
                  <p className="mt-6 text-sm text-slate-500">
                    ...
                    <Link href="/community" className="text-[#00a859] hover:underline">
                      join the community
                    </Link>
                  </p>
                </section>
