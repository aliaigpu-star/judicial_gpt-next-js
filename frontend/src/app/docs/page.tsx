    ...
    <SiteShell>
      ...
      >
        <div className="flex flex-wrap gap-3">
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0c9344] text-white font-bold text-sm shadow-md shadow-[#0c9344]/25 hover:bg-[#0c9344] transition-colors"
          >
            Get Started Free
          </Link>
          <Link
            href="/help"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-semibold text-sm hover:border-[#0c9344]/25 transition-colors"
          >
            Help Center
          </Link>
        </div>
                    ...
                    <li key={id}>
                      <a
                        ...
                        className={`flex items-center gap-2.5 px-3 py-2.5 text-sm rounded-lg transition-colors ${
                          activeSection === id
                            ? 'bg-[#0c9344] text-white font-semibold shadow-sm'
                            : 'text-slate-600 hover:bg-[#0c9344]/10 hover:text-[#0c9344]'
                        }`}
                      >
              ...
              {NAV.map(({ id, label }) => (
                <a
                  ...
                  className={`shrink-0 px-4 py-2 rounded-full text-xs font-bold border ${
                    activeSection === id
                      ? 'bg-[#0c9344] text-white border-[#0c9344]'
            ...
            <div className="space-y-16 lg:space-y-20 min-w-0">
              ...
              <FadeIn>
                <section id="getting-started" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                      <Rocket className="w-5 h-5 text-[#0c9344]" />
                    </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={card.step}
                        className="p-5 rounded-2xl border border-slate-200 bg-[#F7FAF8] hover:border-[#0c9344]/25 transition-colors"
                      >
                        <span className="text-xs font-bold text-[#0c9344]">{card.step}</span>
              ...
              <FadeIn>
                <section id="features" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                      <Layers className="w-5 h-5 text-[#0c9344]" />
                    </div>
                    <h2 className="font-heading text-2xl md:text-3xl font-semibold text-slate-900">
                      Features
                    </h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {CORE_FEATURES.map((feat) => (
                      <div
                        key={feat.title}
                        className="p-5 rounded-2xl border border-slate-200 bg-white hover:shadow-md hover:border-[#0c9344]/25 transition-all"
                      >
                  ...
                  <Link
                    href="/features"
                    className="inline-flex items-center gap-1 mt-6 text-sm font-semibold text-[#0c9344] hover:underline"
                  >
              ...
              <FadeIn>
                <section id="architecture" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                      <Server className="w-5 h-5 text-[#0c9344]" />
                    </div>
                    <h2 className="font-heading text-2xl md:text-3xl font-semibold text-slate-900">
                      Architecture
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-200">
                      {[
                        ...
                        <div key={label} className="p-6 bg-white">
                          <Icon className="w-5 h-5 text-[#0c9344] mb-3" />
                    ...
                    <div className="p-6 bg-[#F7FAF8] border-t border-slate-200">
                      ...
                      <ul className="grid sm:grid-cols-2 gap-2">
                        {TECH_STACK.models.map((model) => (
                          ...
                          >
                            <span className="text-[#0c9344] shrink-0">→</span>
                            {model}
                          </li>
                        ))}
                      </ul>
                ...
                <section id="security" className="scroll-mt-28">
                  ...
                  <ul className="grid sm:grid-cols-2 gap-3">
                    {SECURITY.map((point) => (
                      <li
                        key={point}
                        className="flex gap-2.5 p-4 rounded-xl border border-[#0c9344]/15 bg-[#0c9344]/10/40 text-sm text-slate-700"
                      >
                        <Shield className="w-4 h-4 text-[#0c9344] shrink-0 mt-0.5" />
                        {point}
                      </li>
                    ))}
                  </ul>
              ...
              <FadeIn>
                <section id="reliability" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-[#0c9344]" />
                    </div>
                    <h2 className="font-heading text-2xl md:text-3xl font-semibold text-slate-900">
                      Reliability
                    </h2>
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-900 to-emerald-950 text-white mb-6">
                    <p className="text-[#0c9344] text-sm font-bold uppercase tracking-wider mb-2">
                      Design principle
                    </p>
                  ...
                  <ul className="space-y-3">
                    {RELIABILITY.map((item) => (
                      <li key={item} className="flex gap-3 text-slate-600 text-sm leading-relaxed">
                        <CheckCircle className="w-4 h-4 text-[#0c9344] shrink-0 mt-0.5" />
                        {item}
                      </li>
                    ))}
                  </ul>
              ...
              <FadeIn>
                <section id="impact" className="scroll-mt-28">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-xl bg-[#0c9344]/15 flex items-center justify-center">
                      <Users className="w-5 h-5 text-[#0c9344]" />
                    </div>
                    <h2 className="font-heading text-2xl md:text-3xl font-semibold text-slate-900">
                      Impact Audiences
                    </h2>
                    ...
                    {(
                      ...
                      <div
                        ...
                        className={`p-6 rounded-2xl border ${
                          accent === 'emerald'
                            ? 'border-[#0c9344]/25 bg-[#0c9344]/10/50'
                            : accent === 'teal'
                              ? 'border-[#0c9344]/25 bg-[#0c9344]/10/40'
                        ...
                        <ul className="space-y-3">
                          {items.map((item) => (
                            <li key={item} className="flex gap-2 text-sm text-slate-600 leading-relaxed">
                              <span className="w-1 h-1 rounded-full bg-[#0c9344] mt-2 shrink-0" />
                              {item}
                            </li>
                          ))}
                        </ul>
                  ...
                  <p className="mt-6 text-sm text-slate-500">
                    ...
                    <Link href="/community" className="text-[#0c9344] hover:underline">
                      join the community
                    </Link>
                  </p>
                </section>
