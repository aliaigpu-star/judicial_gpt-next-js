    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-black flex flex-col">
            ...
            <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-2">
                <div className="max-w-3xl mx-auto flex items-center justify-between">
                        ...
                        <div className="w-8 h-8 rounded-full flex items-center justify-center overflow-hidden">
                            <img
                                ...
                                onError={(e) => {
                                    ...
                                    if (parent) {
                                        parent.className = 'w-8 h-8 rounded-full bg-[#00a859] flex items-center justify-center';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link
                            href="/register"
                            className="px-3 py-1.5 bg-[#00a859] text-white text-sm rounded-lg hover:bg-[#00a859] transition-colors"
                        >
                            Try JudicialGPT
                        </Link>
                    </div>
            ...
            <main className="flex-1 w-full max-w-3xl mx-auto py-6 px-4">
                                        ...
                                        <div className="w-7 h-7 rounded-full flex items-center justify-center overflow-hidden">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    ...
                                                    const parent = target.parentElement;
                                                    if (parent) {
                                                        parent.className = 'w-7 h-7 rounded-full bg-[#00a859] flex items-center justify-center';
                                                        parent.innerHTML = '<div class="text-white text-xs font-bold" style="font-family: \'Century\', \'Century Gothic\', \'Times New Roman\', serif">JG</div>';
                                                    }
                                                }}
                                            />
                ...
                {/* CTA */}
                <div className="mt-8 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-[#00a859]/20 dark:to-[#00a859]/20 rounded-xl text-center">
                    ...
                    <Link
                        href="/register"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-[#00a859] text-white rounded-lg hover:bg-[#00a859] transition-colors font-medium"
                    >
            ...
            <footer className="border-t border-gray-200 dark:border-gray-800 py-4 mt-8">
                <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                    Powered by <span className="text-[#00a859] font-medium">JudicialGPT</span>
                </p>
            </footer>
        </div>
    );
