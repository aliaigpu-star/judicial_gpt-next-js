                ...
                <FadeIn key={clause.id} delay={i * 0.04}>
                  <article
                    ...
                    className={`scroll-mt-28 rounded-2xl border p-6 md:p-8 ${
                      isHighlight
                        ? 'border-[#00a859] bg-white shadow-lg shadow-[#00a859]/5 ring-1 ring-emerald-100'
                        ...
                        <p key={para} className="text-slate-600 text-sm md:text-base leading-relaxed">
                          {para.includes(SITE.email) ? (
                            <>
                              ...
                              <a href={`mailto:${SITE.email}`} className="text-[#00a859] hover:underline">
                                {SITE.email}
                              </a>
                            </>
                            ...
                            <>
                              ...
                              <Link href="/privacy" className="text-[#00a859] hover:underline">
                                Privacy Policy
                              </Link>
