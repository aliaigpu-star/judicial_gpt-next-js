        ...
        <div className="h-screen flex flex-col bg-[#0a0a0a] border-r border-gray-800 w-64 fixed left-0 top-0">
            ...
            <div className="p-4 border-b border-gray-800">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#00a859] to-[#00a859] rounded-xl flex items-center justify-center">
                            ...
                            >
                                ...
                                {active && (
                                    <motion.div
                                        ...
                                        className="ml-auto w-1.5 h-1.5 bg-[#00a859] rounded-full"
                                    />
                                )}
                            </motion.div>
                        </Link>
            ...
            <div className="p-3 border-t border-gray-800">
                <div className="flex items-center gap-3 px-3 py-2 mb-2">
                    {user?.avatarUrl ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00a859] to-[#00a859] flex items-center justify-center text-white font-semibold">
