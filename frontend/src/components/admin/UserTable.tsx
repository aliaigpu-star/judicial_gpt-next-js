...
const statusColors: Record<string, string> = {
    active: 'bg-[#00a859]/10 text-[#00a859]',
                                ...
                                <th className="text-center py-4 px-6 w-12">
                                    ...
                                    >
                                        {allSelected ? (
                                            ...
                                            <div className="w-4 h-4 border-2 border-[#00a859] rounded bg-[#00a859]/20" />
                                        ) : (
                            ...
                            return (
                                <motion.tr
                                    ...
                                    className={`border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors ${
                                        selectedUsers.includes(user.id) ? 'bg-[#00a859]/5' : ''
                                    }`}
                                >
                                    {onSelectUser && (
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-1 text-gray-400 text-sm">
                                                    ...
                                                    {user.email}
                                                    {user.emailVerified && (
                                                        <CheckCircle className="h-3 w-3 text-[#00a859] ml-1" />
                                                    )}
                                                </div>
                                            </div>
                                        </div>
