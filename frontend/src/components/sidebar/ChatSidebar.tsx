            ...
            >
                {isEditing ? (
                    ...
                    <>
                        ...
                        {conv.isPinned && (
                            <Pin className="w-3 h-3 text-[#10a37f] flex-shrink-0 opacity-60" />
                        )}
                ...
                <div className="flex flex-col gap-0.5 items-center pt-2 pb-1">
                    ...
                    <button
                        ...
                        className={`w-10 h-10 flex items-center justify-center rounded-xl transition-colors ${isJudgmentSearchActive
                            ? 'bg-[#10a37f]/15 dark:bg-[#10a37f]/10'
                ...
                <div className="mt-auto pt-4 pb-2">
                    ...
                    >
                        {user?.avatarUrl ? (
                            ...
                            <div className="w-6 h-6 rounded-full bg-[#10a37f] flex items-center justify-center text-white text-xs font-medium">
                                ...
                                <div className="py-1">
                                    ...
                                    {user?.role === 'admin' && (
                                        <Link href="/admin" onClick={() => setShowUserMenu(false)}>
                                            <div className="w-full px-4 py-2.5 text-left text-sm hover:bg-[#f4f4f4] dark:hover:bg-[#424242] flex items-center gap-3 text-[#10a37f] transition-colors">
            ...
            <div className="px-3 py-2 space-y-1">
                ...
                <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg transition-all duration-200 ${isJudgmentSearchActive
                        ? 'bg-[#10a37f]/10 dark:bg-[#10a37f]/10 text-[#10a37f]'
                        : 'text-[#0d0d0d] dark:text-[#ececec] hover:bg-[#ececec] dark:hover:bg-[#2f2f2f]'
                        }`}
                >
                    <Scale className={`w-4 h-4 ${isJudgmentSearchActive ? 'text-[#10a37f]' : ''
                        }`} />
                    Judgment Search
                </button>
