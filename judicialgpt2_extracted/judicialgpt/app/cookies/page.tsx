    ...
    <SiteShell>
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="flex items-start gap-5 p-8 rounded-3xl bg-gradient-to-br from-emerald-50 to-[#F2FBF6] border border-emerald-100 mb-14">
              <div className="w-14 h-14 rounded-2xl bg-white border border-emerald-200 flex items-center justify-center shrink-0 shadow-sm">
            ...
            {CATEGORIES.map((cat, i) => {
              ...
              return (
                <FadeIn key={cat.name} delay={i * 0.06}>
                  <div className="rounded-2xl border border-slate-200 overflow-hidden hover:border-emerald-200 transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {cat.examples.map((ex) => (
                          <span
                            key={ex}
                            className="px-3 py-1 text-xs font-medium rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-100"
                          >
                            {ex}
                          </span>
                        ))}
          ...
          <FadeIn>
            <section className="p-8 rounded-2xl border border-emerald-200 bg-emerald-50/50 text-center">
              ...
              <p className="text-slate-600 text-sm mb-4">
                ...
                <a href={`mailto:${SITE.email}`} className="text-emerald-600 font-semibold hover:underline">
                  {SITE.email}
                </a>
              </p>
              <Link
