    ...
    <SiteShell>
      ...
      >
        <div className="flex flex-wrap gap-3">
          <Link href="/signup" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-500 text-white font-bold shadow-md shadow-emerald-500/25 hover:bg-emerald-600 transition-colors">
            Try JudicialGPT <ArrowRight className="w-4 h-4" />
          </Link>
          <Link href="/docs" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 bg-white text-slate-700 font-semibold hover:border-emerald-200 hover:bg-emerald-50/50 transition-colors">
            Read Documentation
          </Link>
        </div>
      </PageHero>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {PROBLEM.points.map((point, i) => (
              <FadeIn key={i} delay={i * 0.05}>
                <div className="h-full p-5 rounded-2xl border border-slate-200 bg-slate-50/80 hover:border-emerald-200 hover:bg-emerald-50/30 transition-all">
                  <div className="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-700 font-bold text-sm flex items-center justify-center mb-3">
            ...
            {CORE_FEATURES.map((feat, i) => {
              ...
              return (
                <FadeIn key={feat.title} delay={i * 0.06}>
                  <div className="group h-full rounded-2xl border border-slate-200 bg-white p-6 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10 hover:border-emerald-200 transition-all duration-300">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-md mb-5">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <FadeIn delay={0.1}>
            <div className="rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-8 shadow-lg shadow-emerald-500/5">
